    ...
    return (
        <div className="footer-container">
            <footer class="footer">
                ...
                <div class="row">
                        ...
                        <div class="footer-widget">
                                <h4 class="mb-4">E-Comm</h4>
                                <p class="lead">Gauarav Gautam Website</p>
                                
                                <div class="">
                                    <p class="mb-0"><strong>Location : </strong>Uttar pradesh ,INDIA</p>
                                    <p><strong>Support Email : </strong> grv.shakya567@gmail.com</p>
                                </div>
                        </div>
                        </div>
            ...
            <div class="footer-btm py-4 ">
                ...
                <div class="row ">
                        <div class="col-lg-6">
                            <p class="copyright mb-0 ">@ Copyright grv.notes.com <a href="grv.notes.com"></a></p>
                        </div>
                        <div class="col-lg-6">
